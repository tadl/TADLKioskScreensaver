...
class SlidesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create slide" do
    assert_difference("Slide.count") do
      post slides_url, params: { slide: { display_seconds: @slide.display_seconds, end_date: @slide.end_date, link: @slide.link, start_date: @slide.start_date, title: @slide.title } }
    end
  ...
  test "should update slide" do
    patch slide_url(@slide), params: { slide: { display_seconds: @slide.display_seconds, end_date: @slide.end_date, link: @slide.link, start_date: @slide.start_date, title: @slide.title } }
