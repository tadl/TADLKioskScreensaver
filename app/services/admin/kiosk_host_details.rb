  ...
  class KioskHostDetails
    ...
    def serialize_heartbeat(heartbeat)
...

      {
        ...
        wireguard_enabled: raw_payload["wireguard_enabled"],
        wireguard_ip_address: raw_payload["wireguard_ip_address"],
        wireguard_status: raw_payload["wireguard_status"],
        wireguard_latest_handshake_at: raw_payload["wireguard_latest_handshake_at"],
        wireguard_handshake_age_seconds: raw_payload["wireguard_handshake_age_seconds"],
